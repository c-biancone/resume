...
\usepackage[left=0.5in,top=0.5in,right=0.5in,bottom=0.5in,columnsep=0.5in,footskip=-16pt]{geometry}
...
\fancyfoot[C]{\tiny\thin github.com/c-biancone/resume}
...
\cvsection{Education}
\vspace{-4pt}
{\large\bold{Rochester Institute of \\ Technology}} \par\smallskip
\vspace{-8pt}
...
\parbox[t]{0.25 \textwidth}{\large{\bold{RTR StrongARM \\Comparator}}}
\hfill
...
\parbox[t]{0.25 \textwidth}{\large{\bold{8-bit RISC CPU}}}
\hfill
